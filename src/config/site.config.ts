...
export const SITE_CONFIG = {
  ...
  services: [
    ...
    { name: "Storm Cleanup", href: "/services/emergency-tree-removal", desc: "Post-storm tree work and property recovery.", image: bucketLiftHouse, alt: "IGY6 Rooted crew with bucket lift performing post-storm tree cleanup at a Florida home" },
