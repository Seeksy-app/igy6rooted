...
export const SITE_CONFIG = {
  ...
  services: [
    { name: "Tree Removal", href: "/services/tree-removal", desc: "Safe removal of hazardous trees.", fact: "Did you know: nearly 1 in 4 homeowner property damage claims involve a fallen tree.", image: treeRemoval, alt: "IGY6 Rooted crew safely removing a large tree at a Niceville, FL home" },
    ...
    { name: "Climbing & Rigging", href: "/services/tree-removal", desc: "Skilled climbers for tight, high-risk jobs.", fact: "Did you know: tree work is one of the top 10 most dangerous jobs in America — leave the climbing to the pros.", image: climberPine, alt: "IGY6 Rooted climber rigging a tall pine tree for controlled removal in Northwest Florida" },
    ...
    { name: "Lot Clearing", href: "/services/lot-clearing", desc: "Full lot prep — stumps, brush, and debris cleared.", fact: "Did you know: Florida building permits often require a fully cleared lot before foundation work begins.", image: landClearing, alt: "Cleared residential lot ready for construction in Northwest Florida" },
    { name: "Brush Removal", href: "/services/brush-removal", desc: "Clear overgrowth and undergrowth fast.", fact: "Did you know: dense brush within 30 ft of a home is one of the top wildfire risk factors.", image: brushRemoval, alt: "Cleared brush and undergrowth along a Northwest Florida property line" },
