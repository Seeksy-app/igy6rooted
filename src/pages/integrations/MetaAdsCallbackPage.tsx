...
export default function MetaAdsCallbackPage() {
  ...
  useEffect(() => {
    ...
    const callbackUrl = `${import.meta.env.VITE_SUPABASE_URL}/functions/v1/meta-ads-oauth-callback`;
    const params = new URLSearchParams({
      code,
      state,
      redirect_uri: `${window.location.origin}/integrations/meta-ads/callback`,
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen gap-4">
      ...
      <p className="text-muted-foreground">Connecting your Meta Ads account...</p>
    </div>
  );
}
